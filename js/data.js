...
const SEED_SETTINGS = {
  ...
  scoreBaselineAdjustment: 0, // устар.: ручная корректировка суммарного балла группы (оставлено для совместимости со старыми данными)
  scoreBaselineAdjustmentGoals: 0,   // ручная корректировка баллов за цели
  scoreBaselineAdjustmentPercent: 0, // ручная корректировка баллов за % выполнения
